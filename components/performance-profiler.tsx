          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{performanceMetrics.avgScanTime.toFixed(2)}s</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{performanceMetrics.throughput.toFixed(1)} f/s</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{getEfficiencyScore()}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{performanceMetrics.bottlenecks.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">Scan Performance</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-purple-900 font-medium">{performanceMetrics.totalScanTime.toFixed(2)}s</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">System Resources</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div>
            ...
            <TabsContent value="engines" className="space-y-4">
              <Card className="bg-purple-50 border-purple-300">
                <CardHeader>
                  <CardTitle className="text-purple-900 text-lg">Engine Performance Analysis</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {Object.entries(performanceMetrics.enginePerformance).map(([engine, perf]) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-purple-900 font-medium capitalize">{engine}</p>
                            <p className="text-purple-600 text-sm">{perf.count} scans</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                          <div className="text-right">
                            <p className="text-purple-900 text-sm">{perf.avgTime.toFixed(3)}s avg</p>
            ...
            <TabsContent value="bottlenecks" className="space-y-4">
              <Card className="bg-purple-50 border-purple-300">
                <CardHeader>
                  <CardTitle className="text-purple-900 text-lg">Performance Bottlenecks</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {performanceMetrics.bottlenecks.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <h3 className="text-lg font-semibold text-purple-900 mb-2">No Bottlenecks Detected</h3>
            ...
            <TabsContent value="optimization" className="space-y-4">
              <Card className="bg-purple-50 border-purple-300">
                <CardHeader>
                  <CardTitle className="text-purple-900 text-lg">Optimization Recommendations</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {performanceMetrics.recommendations.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        <CheckCircle className="w-12 h-12 text-green-400 mx-auto mb-4" />
                        <h3 className="text-lg font-semibold text-purple-900 mb-2">System Optimized</h3>
                  ...
                  <div className="mt-6 p-4 bg-purple-50 border border-purple-300 rounded">
                    <h4 className="text-purple-900 font-medium mb-3">Quick Optimization Actions</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      <button className="p-2 bg-purple-500 hover:bg-purple-400 rounded text-purple-900 text-sm transition-colors">
