        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-200">Efficiency Score</p>
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-200">Bottlenecks</p>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-200">Average Time</span>
                        <span
                      ...
                      <div className="flex justify-between">
                        <span className="text-gray-200">Fastest Scan</span>
                        <span className="text-green-400 font-medium">{performanceMetrics.fastestScan.toFixed(2)}s</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-200">Slowest Scan</span>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div>
                        ...
                        <Progress value={systemStats.cpu_usage} className="bg-gray-900" />
                      </div>
                      <div>
                        <div className="flex justify-between mb-1">
                        ...
                        <Progress value={systemStats.memory_usage} className="bg-gray-900" />
                      </div>
                      <div>
                        <div className="flex justify-between mb-1">
                          <span className="text-gray-200">Disk Usage</span>
                          <span
                        ...
                        <Progress value={systemStats.disk_usage} className="bg-gray-900" />
                      </div>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-purple-300 text-sm">{perf.count} scans</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                          <div className="text-right">
                            <p className="text-white text-sm">{perf.avgTime.toFixed(3)}s avg</p>
                            <p className="text-purple-300 text-xs">{perf.efficiency.toFixed(1)} f/s</p>
                          </div>
                          <Badge
                            className={
                  ...
                  <div className="space-y-3">
                    {performanceMetrics.bottlenecks.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-200">System is performing optimally</p>
                      </div>
                    )}
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {performanceMetrics.recommendations.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-200">No optimization recommendations at this time</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-gray-800 border border-gray-700 rounded">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      <button className="p-2 bg-purple-600 hover:bg-purple-600 rounded text-white text-sm transition-colors">
