      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-4">
            ...
            <Progress value={realTimeStats.cpu.usage} className="mt-2 bg-gray-900" />
          </CardContent>
        </Card>
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="text-sm text-gray-200">Disk Usage</p>
                <p className="text-2xl font-bold text-white">
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-4">
            ...
            <div className="mt-2 text-xs text-purple-300">Max: {config.threadPool}</div>
          </CardContent>
        </Card>
      </div>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <Progress value={realTimeStats.cpu.usage} className="bg-gray-900" />
                    </div>

                    <div className="grid grid-cols-2 gap-4 pt-2">
                      <div className="text-center p-2 bg-gray-800 rounded">
                        <p className="text-xs text-purple-300">Cores</p>
                        <p className="text-lg font-bold text-white">{realTimeStats.cpu.cores}</p>
                      </div>
                      <div className="text-center p-2 bg-gray-800 rounded">
                        <p className="text-xs text-purple-300">Temperature</p>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-2">
                      ...
                      <div className="text-center p-2 bg-gray-800 rounded">
                        <p className="text-xs text-purple-300">Usage %</p>
                        <p className="text-lg font-bold text-white">
                          {((realTimeStats.memory.used / realTimeStats.memory.total) * 100).toFixed(1)}%
                        </p>
                      </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="text-center p-3 bg-gray-800 rounded">
                      <p className="text-xs text-purple-300">Disk Usage</p>
                      <p className="text-xl font-bold text-white">
                        {((realTimeStats.disk.used / realTimeStats.disk.total) * 100).toFixed(1)}%
                      </p>
                    </div>
                    <div className="text-center p-3 bg-gray-800 rounded">
                      <p className="text-xs text-purple-300">Free Space</p>
                      <p className="text-xl font-bold text-white">
                        {(realTimeStats.disk.total - realTimeStats.disk.used).toFixed(0)} GB
                      </p>
                    </div>
                    <div className="text-center p-3 bg-gray-800 rounded">
                      <p className="text-xs text-purple-300">Read Speed</p>
                      <p className="text-xl font-bold text-white">{realTimeStats.disk.read.toFixed(1)} MB/s</p>
                    </div>
                    <div className="text-center p-3 bg-gray-800 rounded">
                      <p className="text-xs text-purple-300">Write Speed</p>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between items-center p-2 bg-gray-800 rounded">
                      <span className="text-gray-200">Main Process</span>
                      <Badge className="bg-green-700">Running</Badge>
                    </div>
                    <div className="flex justify-between items-center p-2 bg-gray-800 rounded">
                      <span className="text-gray-200">Worker Threads</span>
                      <Badge className="bg-blue-700">{realTimeStats.processes.threads}</Badge>
                    </div>
                    <div className="flex justify-between items-center p-2 bg-gray-800 rounded">
                      <span className="text-gray-200">Engine Processes</span>
                      <Badge className="bg-purple-600">{config.engines.length}</Badge>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-200">Total Processes</span>
                      <span className="text-white font-bold">{realTimeStats.processes.total}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-200">Probium Processes</span>
                      <span className="text-white font-bold">{realTimeStats.processes.probium}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-200">Thread Pool Size</span>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-gray-800 rounded">
                      <p className="text-sm text-purple-300">Incoming</p>
                      <p className="text-2xl font-bold text-white">{realTimeStats.network.in.toFixed(1)} KB/s</p>
                    </div>
                    <div className="text-center p-4 bg-gray-800 rounded">
                      <p className="text-sm text-purple-300">Outgoing</p>
