          ...
          <CardContent className="space-y-4">
            ...
            >
              ...
              {isDragActive ? (
                ...
                <div>
                  <p className="text-purple-300 mb-2">Drag & drop a file here, or click to select</p>
            ...
            {scanStatus === "scanning" && (
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-200">{currentStage}</span>
                  <span className="text-gray-200">{Math.round(scanProgress)}%</span>
                </div>
                <Progress value={scanProgress} className="bg-gray-900" />
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-purple-300">Comprehensive file structure analysis</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-purple-300">MD5, SHA1, SHA256, CRC32</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-purple-300">Author, creation date, properties</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-purple-300">Digital signature verification</p>
                    </div>
                    <Switch
            ...
            <Tabs defaultValue="overview" className="space-y-4">
              ...
              <TabsContent value="overview" className="space-y-4">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="p-3 bg-gray-800 rounded-lg">
                    <p className="text-xs text-purple-300">Scan Time</p>
                ...
                <div className="space-y-2">
                  <p className="text-sm font-medium text-gray-200">Engines Used:</p>
                  ...
                  {scanDetails.metadata &&
                    Object.entries(scanDetails.metadata).map(([key, value]) => (
                      <div key={key} className="p-3 bg-gray-800 rounded-lg">
                        <p className="text-xs text-purple-300 capitalize">{key.replace(/([A-Z])/g, " $1")}</p>
                  ...
                  {scanDetails.security && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="p-4 bg-gray-800 rounded-lg">
                        <p className="text-xs text-purple-300">Malware Score</p>
                        <p className="text-2xl font-bold text-white">{scanDetails.security.malware_score}</p>
                      </div>
                      <div className="p-4 bg-gray-800 rounded-lg">
                        <p className="text-xs text-purple-300">Threat Level</p>
                        <Badge
                          className={`mt-1 ${
                      ...
                      <div className="p-4 bg-gray-800 rounded-lg">
                        <p className="text-xs text-purple-300">Embedded Files</p>
