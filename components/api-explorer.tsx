          ...
          <Tabs defaultValue="endpoints" className="space-y-4">
            ...
            <TabsContent value="endpoints" className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">API Request</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-purple-700 text-sm">Endpoint</label>
                      <Select value={selectedEndpoint} onValueChange={setSelectedEndpoint}>
                        <SelectTrigger className="bg-purple-50 border-purple-300 text-purple-900">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="bg-purple-200 border-purple-300">
                          {Object.entries(apiEndpoints).map(([key, endpoint]) => (
                            <SelectItem key={key} value={key} className="text-purple-900">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="bg-purple-50 border-purple-300 text-purple-900 font-mono text-sm"
                        rows={10}
                      />
                    </div>
              ...
              <Card className="bg-purple-50 border-purple-300">
                <CardHeader>
                  <CardTitle className="text-purple-900 text-lg">Endpoint Details</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="examples" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">Python Example</CardTitle>
                  </CardHeader>
                  <CardContent>
...
`}
                ...
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">cURL Example</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <pre className="text-sm text-purple-600 bg-purple-50 p-4 rounded overflow-x-auto">
                      {`curl -X POST \\
...
`}
                ...
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">JavaScript Example</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <pre className="text-sm text-purple-600 bg-purple-50 p-4 rounded overflow-x-auto">
...
`}
                ...
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">Go Example</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <pre className="text-sm text-purple-600 bg-purple-50 p-4 rounded overflow-x-auto">
                      {`package main
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 bg-purple-50 rounded border border-purple-300">
                      <h3 className="text-purple-900 font-medium mb-2">Python SDK</h3>
                    ...
                    <div className="p-4 bg-purple-50 rounded border border-purple-300">
                      <h3 className="text-purple-900 font-medium mb-2">Node.js SDK</h3>
                    ...
                    <div className="p-4 bg-purple-50 rounded border border-purple-300">
                      <h3 className="text-purple-900 font-medium mb-2">Go SDK</h3>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="p-3 bg-purple-50 rounded border border-purple-300">
                      <h3 className="text-purple-900 font-medium">Authentication</h3>
                    ...
                    <div className="p-3 bg-purple-50 rounded border border-purple-300">
                      <h3 className="text-purple-900 font-medium">Rate Limiting</h3>
                      <p className="text-purple-700 text-sm">
                    ...
                    <div className="p-3 bg-purple-50 rounded border border-purple-300">
                      <h3 className="text-purple-900 font-medium">Error Handling</h3>
                      <p className="text-purple-700 text-sm">
                    ...
                    <div className="p-3 bg-purple-50 rounded border border-purple-300">
                      <h3 className="text-purple-900 font-medium">Webhooks</h3>
                      <p className="text-purple-700 text-sm">
