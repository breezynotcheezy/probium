        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-4">
            ...
            <div className="mt-2 flex items-center gap-1">
              ...
              <span className="text-xs text-purple-300">{isScanning ? "Scanning" : "Idle"}</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-200">Connections</p>
                <p className="text-2xl font-bold text-white">{Math.round(activeConnections)}</p>
              </div>
            </div>
            <div className="mt-2 text-xs text-purple-300">API endpoints active</div>
          </CardContent>
        </Card>
      </div>
                    ...
                    <div className="space-y-2">
                      {logs.map((log) => {
                        ...
                        return (
                          <div
                            key={log.id}
                            className="flex items-start gap-3 p-3 bg-gray-800 rounded border border-gray-700 hover:bg-gray-800 transition-colors"
                          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-200">Disk</span>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-200">Overall Status</span>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-gray-200">Total Scans</span>
                      <span className="text-white">{systemStats.total_scans}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-200">Active Engines</span>
                    ...
                    {Object.entries(systemStats.engine_stats).map(([engineName, stats]) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-gray-200 capitalize">{engineName}</span>
                        </div>
