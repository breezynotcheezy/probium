          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{systemStats.cpu_usage.toFixed(1)}%</p>
              </div>
            </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{systemStats.memory_usage.toFixed(1)}%</p>
              </div>
            </div>
            <div className="mt-2 w-full bg-purple-100 rounded-full h-2">
              <div
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{systemStats.active_threads}</p>
              </div>
            </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{Math.round(activeConnections)}</p>
              </div>
            </div>
        ...
        <CardContent>
          <Tabs defaultValue="logs" className="space-y-4">
            ...
            <TabsContent value="logs" className="space-y-4">
              <Card className="bg-purple-50 border-purple-300">
                <CardHeader>
                  <CardTitle className="text-purple-900 text-lg">Live Activity Feed</CardTitle>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-purple-900 text-sm">{log.message}</p>
                            </div>
                          </div>
                        )
                      })}
            ...
            <TabsContent value="performance" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">Resource Usage</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-purple-700">CPU</span>
                        <span className="text-purple-900">{systemStats.cpu_usage.toFixed(1)}%</span>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-purple-900">{systemStats.memory_usage.toFixed(1)}%</span>
                      </div>
                      <div className="w-full bg-purple-50 rounded-full h-2">
                        <div
                          className="bg-green-500 h-2 rounded-full transition-all duration-500"
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-purple-900">{systemStats.disk_usage.toFixed(1)}%</span>
                      </div>
                      <div className="w-full bg-purple-50 rounded-full h-2">
                        <div
                ...
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">System Health</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-purple-900">24h 15m</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-purple-700">Total Scans</span>
                      <span className="text-purple-900">{systemStats.total_scans}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-purple-700">Active Engines</span>
                      <span className="text-purple-900">{Object.keys(systemStats.engine_stats).length}</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <TabsContent value="engines" className="space-y-4">
              <Card className="bg-purple-50 border-purple-300">
                <CardHeader>
                  <CardTitle className="text-purple-900 text-lg">Engine Status</CardTitle>
                </CardHeader>
                <CardContent>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-4">
                          <div className="text-right">
                            <p className="text-purple-900 text-sm">{stats.scans_completed} scans</p>
