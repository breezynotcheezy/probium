        ...
        <Card className="bg-purple-50 border-purple-300">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <Label className="text-purple-900">Parallel Processing</Label>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label className="text-purple-900">Skip Duplicates</Label>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label className="text-purple-900">Generate Report</Label>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label className="text-purple-900">Auto Export</Label>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <h3 className="font-semibold text-purple-900">Batch Processing Progress</h3>
              ...
              {currentFile && (
                <p className="text-sm text-purple-700">
                  Currently processing: <span className="font-medium text-purple-900">{currentFile}</span>
                </p>
              )}
            </div>
          </CardContent>
