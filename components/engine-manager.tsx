          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{config.engines.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <Tabs defaultValue="engines" className="space-y-4">
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="font-semibold text-purple-900">{details.name}</h3>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-xs">
                            ...
                            <span className="text-purple-900">{stats.performance}%</span>
                          </div>
            ...
            <TabsContent value="performance" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">Usage Statistics</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {Object.entries(engineStats).map(([engineId, stats]) => (
                      <div key={engineId} className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          <p className="text-purple-900 font-medium">{stats.scansCompleted.toLocaleString()}</p>
            ...
            <TabsContent value="advanced" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">Thread Pool Configuration</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                ...
                <Card className="bg-purple-50 border-purple-300">
                  <CardHeader>
                    <CardTitle className="text-purple-900 text-lg">Engine Priorities</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
